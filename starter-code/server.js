...
// This is connecting the Postgres database to Node.js
...
app.get('/articles', function(request, response) {
  ...
  client.query(`
    ...
    // It allow for input of an character and puts it as a string with a max amount of characters set at 20
    // +++++++++++++++++++++
...
// 'get' requests data from the server while 'post' submits data to be processed
app.post('/articles', function(request, response) {
  ...
  function queryTwo() {
    client.query(
      ...
      // $1 is referring to the first argument of author.
...
app.put('/articles/:id', function(request, response) {
  ...
  function queryTwo(author_id) {
    client.query(
      // DONE: INSERT is adding data to a table while UPDATE is adjusting the data of an already existing row.  INSERT aligns with CREATE or PUSH and UPDATE aligns with UPDATE/PUT for REST and CRUD components.
      `UPDATE authors
...
app.delete('/articles/:id', function(request, response) {
  ...
  client.query(
    ...
    // The value comes from articles table and requests the value id.
    [request.params.id]
  );
  // DONE: #5
